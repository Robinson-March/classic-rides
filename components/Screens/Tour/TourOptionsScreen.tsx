...
const timeString = now.toLocaleTimeString([], { hour: 'numeric', minute: '2-digit', hour12: true }); // e.g., "4:00 PM"
  ...
  return (
      ...
      style={{ height: crHeight * 0.8,width:crWidth*.85 }}
  ...
  <View style={styles.headerInfo}>
            <CRText font='Jura' weight='bold'>{cars[tourPackage?.tourCar]?.name}</CRText>
        </View>
    
    <View style={{backgroundColor:'#f0f0f0',padding:20,borderRadius:20,gap:30}}>
 <View style={{gap:5}}>
            <CRText font='Jura' weight='medium' >
                Pickup Location
            </CRText>
            <CRText weight='bold' >
                Classic Cars HeadQuaters
            </CRText>
            <CRText  >
                23 madeup address,Atlanta
            </CRText>
        </View>
         <View style={{gap:5}}>
            <CRText font='Jura' weight='medium' >
...
<CRText >
  {timeString}
        ...
        <View style={{backgroundColor:CRColors.tintYellow,padding:10,borderRadius:50,}}>
      <CRText font='Jura' weight='medium' >
    ...
    >
      ...
      <CRText font="Karla">{reminder}</CRText>
                    ...
                    <View style={[generalStyles.generalBottom, { gap: 10 }]}>
                        ...
                        <TealButton title="Choose this ride" onPress={()=>navigation.navigate("touroptions")} />
                    </View>
                </View>
            </SafeAreaView>
  )
