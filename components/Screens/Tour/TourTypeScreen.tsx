...
export default function TourTypeScreen({navigation}) {
  ...
  return (
    <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
                ...
                >
      <CRText size={24}>
        {"For "+tourLength[tourPackage?.tourlength]}
      </CRText>
          <View style={{ gap: 20,backgroundColor:"#EAEAEA",borderRadius:20,padding:20 }}>
            <CRText weight='medium'>Select your preference</CRText>
                        <OutlineButton style={[generalStyles.outlineButton,{borderColor:CRColors.accent,backgroundColor:"#fff"}]} onPress={() => handleSelect("Book Now")}>
                            <CRText>Book Now</CRText>
                        </OutlineButton>
                        <OutlineButton style={[generalStyles.outlineButton,{borderColor:CRColors.accent,backgroundColor:"#fff"}]} onPress={() => handleSelect("Schedule Later")}>
